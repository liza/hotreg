...
<!-- User Menu -->
        <div class="width-wrapper">	
          ...
          <div id="user-menu"><?php print render($page['user_menu']); ?></div>  
        </div>   
...
<!-- The All Knowing All Seeing Footer Block -->
      ...
      Designed by <a href="http://www.themeshark.com">ThemeShark.com</a> | Sponsored by <a href="http://www.desponder.com">Desponder.com</a>
	  </div></div><!-- /footer -->
