...
<?php if (theme_get_setting('slideshow_display','company')): ?>
  <?php 
  $slide1_head = theme_get_setting('slide1_head','company'); 
  $slide2_head = theme_get_setting('slide2_head','company'); 
  $slide3_head = theme_get_setting('slide3_head','company'); 
  $slide1_desc = theme_get_setting('slide1_desc','company'); 
  $slide2_desc = theme_get_setting('slide2_desc','company'); 
  $slide3_desc = theme_get_setting('slide3_desc','company'); 
  ...
  <div id="footer">
    <div id="footer-widgets" class="clearfix">
     <?php if ($page['footer_first']): ?>
      <div class="footer-widget"><?php print render($page['footer_first']); ?></div>
      <?php endif; ?>
      <?php if ($page['footer_second']): ?>
      <div class="footer-widget"><?php print render($page['footer_second']); ?></div>
      <?php endif; ?>
      <?php if ($page['footer_third']): ?>
      <div class="footer-widget"><?php print render($page['footer_third']); ?></div>
      <?php endif; ?>
      <?php if ($page['footer_fourth']): ?>
      <div class="footer-widget remove-margin"><?php print render($page['footer_fourth']); ?></div>
      <?php endif; ?>
    </div>
  </div>
  <?php endif; ?>
