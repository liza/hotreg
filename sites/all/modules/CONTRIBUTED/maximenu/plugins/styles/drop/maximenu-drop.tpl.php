...
<div id="menu-<?php print $maximenu_name; ?>-ul-wrapper" class="menu-ul-wrapper clearfix">
  <ul id="menu-<?php print $maximenu_name; ?>" class="menu">
    <?php foreach ($links['links'] as $key => $content): ?>
      <?php $count++; ?>
      <?php print theme('maximenu_drop_links', array('content' => $content, 'maximenu_name' => $maximenu_name, 'skin' => $skin, 'disabled' => $disabled, 'key' => $key, 'code' => $code, 'count' => $count, 'total' => $total)); ?>          
    <?php endforeach; ?>
  </ul><!-- /.menu -->    
</div><!-- /.menu-ul-wrapper -->   
